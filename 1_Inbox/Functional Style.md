...
As we mentioned [[1_Inbox/JS and TS Fullstack Development|here]] `JavaScript` supports many styles, such as functional programming to a point.
 1. Functions are first-class [[1_Inbox/Objects]]
...
Transform datastructures with [[1_Inbox/Filter]] , [[Map]] and [[1_Inbox/Reduce]]
